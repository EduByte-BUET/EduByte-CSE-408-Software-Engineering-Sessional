...
result_gen_router.route("/").post(async (req, res) => {
    ...
    const chat = model.startChat({
      ...
      history: [
        ...
        {
          role: "user",
          parts: [{ text: "\"question\": \"What is the purpose of a 'try-except' block in Python?\",\n\"user_answer\": \"\"\n}"}],
        },
        {
          role: "model",
