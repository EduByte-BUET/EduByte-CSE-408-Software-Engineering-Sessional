...
const postData = [
	{
		...
		summary:
			"If we run BFS for finding the shortest path, what will be the time complexity?",
		post_type: "question",
		upvotes: 345,
		downvotes: 9,
		replies: [
			{
				...
				summary:
					"Great question! The time complexity would generally be O(V+E) for BFS.",
				author_id: 2,
				author_type: "user",
				...
				replies: [
					{
						...
						summary:
							"Don't forget that the complexity can vary based on the graph representation.",
						author_id: 3,
		...
		replies: [
			{
				...
				summary:
					"That sounds like an interesting challenge! Have you considered using a depth-first search?",
				author_id: 5,
				author_type: "user",
	...
	},
	{
		...
		summary:
			"Discussing the beauty of Euclidean Geometry and its applications.",
		post_type: "discussion",
		upvotes: 50,
		downvotes: 5,
		replies: [
						...
						<div>
							<button
								className={`btn btn-sm ${
									activePost === comment.post_id && replyBoxVisible
										? "btn-primary"
										: "btn-outline-primary"
								}`}
